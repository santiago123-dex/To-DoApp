        ...
        <>
            ...
            <div className="w-110 min-w-100 min-h-150 flex flex-col items-center justify-center bg-white h-auto rounded-xl p-8 shadow-xl">
                <div className="w-full flex flex-col justify-center items-center p-3">
                    ...
                    <h2 className="text-2xl text-black font-bold mt-5">Bienvenido de vuelta</h2>
                    <p className="text-gray-400 mt-2">Inicia sesión para acceder a tu tablero</p>
                </div>
                <form className="w-full flex flex-col justify-center p-3 gap-1">
                    ...
                    <button type="submit" className="p-2 text-white bg-[#0da2e7] rounded-lg mt-3 font-bold">Iniciar Sesión</button>
                    <p className="text-gray-400 mt-3 text-center">¿No tienes cuenta? <Link href="register">Registrate gratis</Link></p>
                </form>
            </div>
        </>
    )
